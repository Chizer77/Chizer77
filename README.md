...
<ul><li><a href=https://github.com/nexu-io/open-design>nexu-io/open-design</a> <span>🎨 Local-first, open-source Claude Design alternative. 🖥️ Native desktop app. ⚡ 259+ Skills · ✨ 142+ Design Systems 🖼️ Web · desktop · mobile prototypes · slides · images · videos · HyperFrames 📦 Sandboxed preview · HTML/PDF/PPTX/MP4 export 🤖 Claude Code / OpenClaw / Codex / Cursor / OpenCode / Qwen / Copilot / Hermes / Kimi & 17+ CLIs.</span></li><li><a href=https://github.com/chenhg5/cc-connect>chenhg5/cc-connect</a> <span>Bridge local AI coding agents (Claude Code, Cursor, Gemini CLI, Codex) to messaging platforms (Feishu/Lark, DingTalk, Slack, Telegram, Discord, LINE, WeChat Work). Chat with your AI dev assistant from anywhere — no public IP required for most platforms.</span></li><li><a href=https://github.com/HKUDS/CLI-Anything>HKUDS/CLI-Anything</a> <span>"CLI-Anything: Making ALL Software Agent-Native" -- CLI-Hub: https://clianything.cc/</span></li><li><a href=https://github.com/larksuite/cli>larksuite/cli</a> <span>The official Lark/Feishu CLI tool, maintained by the larksuite team — built for humans and AI Agents. Covers core business domains including Messenger, Docs, Base, Sheets, Calendar, Mail, Tasks, Meetings, and more, with 200+ commands and 20+ AI Agent Skills.</span></li><li><a href=https://github.com/AstrBotDevs/AstrBot>AstrBotDevs/AstrBot</a> <span>AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/alchaincyf/nuwa-skill>alchaincyf/nuwa-skill</a> <span>你想蒸馏的下一个员工，何必是同事。蒸馏任何人的思维方式——心智模型、决策启发式、表达DNA。Distill how anyone thinks.</span></li><li><a href=https://github.com/NousResearch/hermes-agent>NousResearch/hermes-agent</a> <span>The agent that grows with you</span></li><li><a href=https://github.com/openclaw/openclaw>openclaw/openclaw</a> <span>Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞</span></li><li><a href=https://github.com/KangJialiang/ViSpec>KangJialiang/ViSpec</a> <span>[NeurIPS 2025] Official Implementation of ViSpec: Accelerating Vision-Language Models with Vision-Aware Speculative Decoding.</span></li><li><a href=https://github.com/nextlevelbuilder/ui-ux-pro-max-skill>nextlevelbuilder/ui-ux-pro-max-skill</a> <span>An AI SKILL that provide design intelligence for building professional UI/UX multiple platforms</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 5/31/26, 10:44 AM<br>Next on: 6/1/26, 10:44 AM<br>Power By <i>GitHub Action</i></b></p>
