...
<ul><li><a href=https://github.com/MHSanaei/3x-ui>MHSanaei/3x-ui</a> <span>Xray panel supporting multi-protocol multi-user expire day & traffic & IP limit (Vmess, Vless, Trojan, ShadowSocks, Wireguard, Hysteria, Tunnel, Mixed, HTTP, Tun, MTProto)</span></li><li><a href=https://github.com/NVlabs/cuda-oxide>NVlabs/cuda-oxide</a> <span>cuda-oxide is an experimental Rust-to-CUDA compiler that lets you write (SIMT) GPU kernels in safe(ish), idiomatic Rust. It compiles standard Rust code directly to PTX — no DSLs, no foreign language bindings, just Rust.</span></li><li><a href=https://github.com/chenhg5/cc-connect>chenhg5/cc-connect</a> <span>Bridge local AI coding agents (Claude Code, Cursor, Gemini CLI, Codex) to messaging platforms (Feishu/Lark, DingTalk, Slack, Telegram, Discord, LINE, WeChat Work). Chat with your AI dev assistant from anywhere — no public IP required for most platforms.</span></li><li><a href=https://github.com/AstrBotDevs/AstrBot>AstrBotDevs/AstrBot</a> <span>AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨</span></li><li><a href=https://github.com/OpenListTeam/OpenList>OpenListTeam/OpenList</a> <span>A new AList Fork to Anti Trust Crisis</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 7/7/26, 10:24 AM<br>Next on: 7/8/26, 10:24 AM<br>Power By <i>GitHub Action</i></b></p>
