...
<ul><li><a href=https://github.com/Dancncn/DansBlog>Dancncn/DansBlog</a> <span>Dan'Blog</span></li><li><a href=https://github.com/DayuanJiang/next-ai-draw-io>DayuanJiang/next-ai-draw-io</a> <span>A next.js web application that integrates AI capabilities with draw.io diagrams. This app allows you to create, modify, and enhance diagrams through natural language commands and AI-assisted visualization.</span></li><li><a href=https://github.com/Astro-Saurav/IDM-Activation-Script>Astro-Saurav/IDM-Activation-Script</a> <span>An open-source tool to activate and reset the trial of Internet Download Manager</span></li><li><a href=https://github.com/NVlabs/cuda-oxide>NVlabs/cuda-oxide</a> <span>cuda-oxide is an experimental Rust-to-CUDA compiler that lets you write (SIMT) GPU kernels in safe(ish), idiomatic Rust. It compiles standard Rust code directly to PTX — no DSLs, no foreign language bindings, just Rust.</span></li><li><a href=https://github.com/OpenListTeam/OpenList>OpenListTeam/OpenList</a> <span>A new AList Fork to Anti Trust Crisis</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/nextlevelbuilder/ui-ux-pro-max-skill>nextlevelbuilder/ui-ux-pro-max-skill</a> <span>An AI SKILL that provide design intelligence for building professional UI/UX multiple platforms</span></li><li><a href=https://github.com/AstrBotDevs/AstrBot>AstrBotDevs/AstrBot</a> <span>AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨</span></li><li><a href=https://github.com/larksuite/cli>larksuite/cli</a> <span>The official Lark/Feishu CLI tool, maintained by the larksuite team — built for humans and AI Agents. Covers core business domains including Messenger, Docs, Base, Sheets, Calendar, Mail, Tasks, Meetings, and more, with 200+ commands and 20+ AI Agent Skills.</span></li><li><a href=https://github.com/HKUDS/CLI-Anything>HKUDS/CLI-Anything</a> <span>"CLI-Anything: Making ALL Software Agent-Native" -- CLI-Hub: https://clianything.cc/</span></li><li><a href=https://github.com/anomalyco/opencode>anomalyco/opencode</a> <span>The open source coding agent.</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 6/23/26, 10:33 AM<br>Next on: 6/24/26, 10:33 AM<br>Power By <i>GitHub Action</i></b></p>
