...
<ul><li><a href=https://github.com/chenhg5/cc-connect>chenhg5/cc-connect</a> <span>Bridge local AI coding agents (Claude Code, Cursor, Gemini CLI, Codex) to messaging platforms (Feishu/Lark, DingTalk, Slack, Telegram, Discord, LINE, WeChat Work). Chat with your AI dev assistant from anywhere — no public IP required for most platforms.</span></li><li><a href=https://github.com/HKUDS/CLI-Anything>HKUDS/CLI-Anything</a> <span>"CLI-Anything: Making ALL Software Agent-Native" -- CLI-Hub: https://clianything.cc/</span></li><li><a href=https://github.com/larksuite/cli>larksuite/cli</a> <span>The official Lark/Feishu CLI tool, maintained by the larksuite team — built for humans and AI Agents. Covers core business domains including Messenger, Docs, Base, Sheets, Calendar, Mail, Tasks, Meetings, and more, with 200+ commands and 20+ AI Agent Skills.</span></li><li><a href=https://github.com/AstrBotDevs/AstrBot>AstrBotDevs/AstrBot</a> <span>AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨</span></li><li><a href=https://github.com/hpjansson/chafa>hpjansson/chafa</a> <span>📺🗿 Terminal graphics for the 21st century.</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/NousResearch/hermes-agent>NousResearch/hermes-agent</a> <span>The agent that grows with you</span></li><li><a href=https://github.com/Innei/Yohaku>Innei/Yohaku</a> <span>余白 / Yohaku — A typographic design system for written content. One accent, three neutral tiers, the rest is whitespace.</span></li><li><a href=https://github.com/msitarzewski/agency-agents>msitarzewski/agency-agents</a> <span>A complete AI agency at your fingertips - From frontend wizards to Reddit community ninjas, from whimsy injectors to reality checkers. Each agent is a specialized expert with personality, processes, and proven deliverables.</span></li><li><a href=https://github.com/sgl-project/sglang>sgl-project/sglang</a> <span>SGLang is a high-performance serving framework for large language models and multimodal models.</span></li><li><a href=https://github.com/AssetRipper/AssetRipper>AssetRipper/AssetRipper</a> <span>GUI application to analyze game files</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 5/26/26, 10:32 AM<br>Next on: 5/27/26, 10:32 AM<br>Power By <i>GitHub Action</i></b></p>
