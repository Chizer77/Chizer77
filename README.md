...
<ul><li><a href=https://github.com/Astro-Saurav/IDM-Activation-Script>Astro-Saurav/IDM-Activation-Script</a> <span>An open-source tool to activate and reset the trial of Internet Download Manager</span></li><li><a href=https://github.com/NVlabs/cuda-oxide>NVlabs/cuda-oxide</a> <span>cuda-oxide is an experimental Rust-to-CUDA compiler that lets you write (SIMT) GPU kernels in safe(ish), idiomatic Rust. It compiles standard Rust code directly to PTX — no DSLs, no foreign language bindings, just Rust.</span></li><li><a href=https://github.com/OpenListTeam/OpenList>OpenListTeam/OpenList</a> <span>A new AList Fork to Anti Trust Crisis</span></li><li><a href=https://github.com/XTLS/Xray-core>XTLS/Xray-core</a> <span>Xray, Penetrates Everything. Also the best v2ray-core. Where the magic happens. An open platform for various uses.</span></li><li><a href=https://github.com/MHSanaei/3x-ui>MHSanaei/3x-ui</a> <span>Xray panel supporting multi-protocol multi-user expire day & traffic & IP limit (Vmess, Vless, Trojan, ShadowSocks, Wireguard, Hysteria, Tunnel, Mixed, HTTP, Tun)</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/QuantumNous/new-api>QuantumNous/new-api</a> <span>A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs into OpenAI-compatible, Claude-compatible, or Gemini-compatible formats. A centralized gateway for personal and enterprise model management. 🍥</span></li><li><a href=https://github.com/tw93/Kami>tw93/Kami</a> <span>👩‍🚒 Good content deserves good paper.</span></li><li><a href=https://github.com/alchaincyf/nuwa-skill>alchaincyf/nuwa-skill</a> <span>你想蒸馏的下一个员工，何必是同事。蒸馏任何人的思维方式——心智模型、决策启发式、表达DNA。Distill how anyone thinks.</span></li><li><a href=https://github.com/chenhg5/cc-connect>chenhg5/cc-connect</a> <span>Bridge local AI coding agents (Claude Code, Cursor, Gemini CLI, Codex) to messaging platforms (Feishu/Lark, DingTalk, Slack, Telegram, Discord, LINE, WeChat Work). Chat with your AI dev assistant from anywhere — no public IP required for most platforms.</span></li><li><a href=https://github.com/msitarzewski/agency-agents>msitarzewski/agency-agents</a> <span>A complete AI agency at your fingertips - From frontend wizards to Reddit community ninjas, from whimsy injectors to reality checkers. Each agent is a specialized expert with personality, processes, and proven deliverables.</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 6/14/26, 10:52 AM<br>Next on: 6/15/26, 10:52 AM<br>Power By <i>GitHub Action</i></b></p>
