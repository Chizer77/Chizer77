...
<ul><li><a href=https://github.com/Innei/Yohaku>Innei/Yohaku</a> <span>余白 / Yohaku — A personal blog design system. The blank space is part of the writing.</span></li><li><a href=https://github.com/JodieRuth/GalgameCharacterSkills>JodieRuth/GalgameCharacterSkills</a> <span>从Galgame的剧情文本或是任何长文本中将一个角色提取为skills或角色卡。</span></li><li><a href=https://github.com/tanishqkumar/ssd>tanishqkumar/ssd</a> <span>A lightweight inference engine supporting speculative speculative decoding (SSD).</span></li><li><a href=https://github.com/sgl-project/sglang>sgl-project/sglang</a> <span>SGLang is a high-performance serving framework for large language models and multimodal models.</span></li><li><a href=https://github.com/chenglou/pretext>chenglou/pretext</a> <span>Fast, accurate & comprehensive text measurement & layout</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/affaan-m/everything-claude-code>affaan-m/everything-claude-code</a> <span>The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.</span></li><li><a href=https://github.com/AssetRipper/AssetRipper>AssetRipper/AssetRipper</a> <span>GUI Application to work with engine assets, asset bundles, and serialized files</span></li><li><a href=https://github.com/fython/BilibiliAPIDocs>fython/BilibiliAPIDocs</a> <span>哔哩哔哩开放接口第三方文档（仅提供官方曾公开接口）</span></li><li><a href=https://github.com/iBUHub/AIStudioToAPI>iBUHub/AIStudioToAPI</a> <span>A wrapper that exposes Google AI Studio as OpenAI, Gemini, and Anthropic compatible APIs.（一个将 Google AI Studio 封装为兼容 OpenAI / Gemini / Anthropic 风格 API 的工具）</span></li><li><a href=https://github.com/bilibili/Index-anisora>bilibili/Index-anisora</a></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 4/16/26, 9:58 AM<br>Next on: 4/17/26, 9:58 AM<br>Power By <i>GitHub Action</i></b></p>
