...
<ul><li><a href=https://github.com/tuteng/Best-websites-a-programmer-should-visit-zh>tuteng/Best-websites-a-programmer-should-visit-zh</a> <span>程序员应该访问的最佳网站中文版</span></li><li><a href=https://github.com/bytedance/deer-flow>bytedance/deer-flow</a> <span>An open-source long-horizon SuperAgent harness that researches, codes, and creates. With the help of sandboxes, memories, tools, skill, subagents and message gateway, it handles different levels of tasks that could take minutes to hours.</span></li><li><a href=https://github.com/PineTreeWss/SpecVLA>PineTreeWss/SpecVLA</a> <span>Implementation of the paper 'Spec-VLA: Speculative Decoding for Vision-Language-Action Models with Relaxed Acceptance' (EMNLP 2025)</span></li><li><a href=https://github.com/chen7086/VLA-ADP>chen7086/VLA-ADP</a> <span>Action aware Dynamic Pruning for Efficient Vision Language Action Manipulation</span></li><li><a href=https://github.com/myunwang/LLMPET>myunwang/LLMPET</a> <span>🐙 盯着 Claude Code 的桌面宠物：随 agent 状态变表情、弹消息气泡、一键授权，并统计 token 用量与花费。本地优先、MIT。</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 9/21/26, 10:38 AM<br>Next on: 9/22/26, 10:38 AM<br>Power By <i>GitHub Action</i></b></p>
