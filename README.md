...
<ul><li><a href=https://github.com/github/spec-kit>github/spec-kit</a> <span>💫 Toolkit to help you get started with Spec-Driven Development</span></li><li><a href=https://github.com/openai/codex>openai/codex</a> <span>Lightweight coding agent that runs in your terminal</span></li><li><a href=https://github.com/anomalyco/opencode>anomalyco/opencode</a> <span>The open source coding agent.</span></li><li><a href=https://github.com/affaan-m/everything-claude-code>affaan-m/everything-claude-code</a> <span>The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.</span></li><li><a href=https://github.com/iBUHub/AIStudioToAPI>iBUHub/AIStudioToAPI</a> <span>A wrapper that exposes Google AI Studio as OpenAI, Gemini, and Anthropic compatible APIs.（一个将 Google AI Studio 封装为兼容 OpenAI / Gemini / Anthropic 风格 API 的工具）</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/vgmstream/vgmstream>vgmstream/vgmstream</a> <span>vgmstream - A library for playback of various streamed audio formats used in video games.</span></li><li><a href=https://github.com/SafeAILab/EAGLE>SafeAILab/EAGLE</a> <span>Official Implementation of EAGLE-1 (ICML'24), EAGLE-2 (EMNLP'24), and EAGLE-3 (NeurIPS'25).</span></li><li><a href=https://github.com/thuml/Time-Series-Library>thuml/Time-Series-Library</a> <span>A Library for Advanced Deep Time Series Models for General Time Series Analysis.</span></li><li><a href=https://github.com/openclaw/openclaw>openclaw/openclaw</a> <span>Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞</span></li><li><a href=https://github.com/AssetRipper/AssetRipper>AssetRipper/AssetRipper</a> <span>GUI Application to work with engine assets, asset bundles, and serialized files</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 3/26/26, 9:45 AM<br>Next on: 3/27/26, 9:45 AM<br>Power By <i>GitHub Action</i></b></p>
