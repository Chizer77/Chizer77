...
<ul><li><a href=https://github.com/Orchestra-Research/AI-Research-SKILLs>Orchestra-Research/AI-Research-SKILLs</a> <span>Comprehensive open-source library of AI research and engineering skills for any AI model. Package the skills and your claude code/codex/gemini agent will be an AI research agent with full horsepower. Maintained by Orchestra Research.</span></li><li><a href=https://github.com/Dancncn/DansBlog>Dancncn/DansBlog</a> <span>Dan'Blog</span></li><li><a href=https://github.com/DayuanJiang/next-ai-draw-io>DayuanJiang/next-ai-draw-io</a> <span>A next.js web application that integrates AI capabilities with draw.io diagrams. This app allows you to create, modify, and enhance diagrams through natural language commands and AI-assisted visualization.</span></li><li><a href=https://github.com/Astro-Saurav/IDM-Activation-Script>Astro-Saurav/IDM-Activation-Script</a> <span>An open-source tool to activate and reset the trial of Internet Download Manager</span></li><li><a href=https://github.com/NVlabs/cuda-oxide>NVlabs/cuda-oxide</a> <span>cuda-oxide is an experimental Rust-to-CUDA compiler that lets you write (SIMT) GPU kernels in safe(ish), idiomatic Rust. It compiles standard Rust code directly to PTX — no DSLs, no foreign language bindings, just Rust.</span></li></ul>

<h3 align="center">Random Stars</h3>

<ul><li><a href=https://github.com/chenglou/pretext>chenglou/pretext</a> <span>Fast, accurate & comprehensive text measurement & layout</span></li><li><a href=https://github.com/openai/codex>openai/codex</a> <span>Lightweight coding agent that runs in your terminal</span></li><li><a href=https://github.com/AstrBotDevs/AstrBot>AstrBotDevs/AstrBot</a> <span>AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨</span></li><li><a href=https://github.com/sgl-project/sglang>sgl-project/sglang</a> <span>SGLang is a high-performance serving framework for large language models and multimodal models.</span></li><li><a href=https://github.com/larksuite/cli>larksuite/cli</a> <span>The official Lark/Feishu CLI tool, maintained by the larksuite team — built for humans and AI Agents. Covers core business domains including Messenger, Docs, Base, Sheets, Calendar, Mail, Tasks, Meetings, and more, with 200+ commands and 20+ AI Agent Skills.</span></li></ul>
...
<p align=center><b>24h Auto-Update<br>Last on: 6/29/26, 10:44 AM<br>Next on: 6/30/26, 10:44 AM<br>Power By <i>GitHub Action</i></b></p>
